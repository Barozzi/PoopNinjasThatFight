...
require_relative '../src/mobs/the_thing'

class TheThingTest < Minitest::Test

  def setup
    @test_mob = TheThing.new
  end
  ...
  def test_special_method
    assert_equal @test_mob.special, [@test_mob.special_text, (@test_mob.str/2)]
  end
